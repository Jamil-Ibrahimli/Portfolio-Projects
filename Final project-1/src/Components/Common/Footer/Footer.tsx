...
const Footer = () => {
    ...
    return (
        ...
        <footer className={classNames(styles.footer, { [styles['footer-active']]: footerActive }, { [styles['footer-active2']]: footerActive2 })} >
            <div className={styles.footer_container} ref={containerRef}>
                <div className={styles.footer_container_uppart}>
                    ...
                    <div className={styles.right}>
                        <div className={styles.right_search}><h3>Keep in touch</h3>
                            <div className={styles.right_search_searcher}>
                                <input type="text" placeholder='Your email' /><button><FaAnglesRight /></button></div>
                        </div>

                        <div className={styles.right_medias}><h3>Follow us</h3>
                            <div className={styles.right_medias_icons}>
